...
/*!
@brief
    Return type of recording session clearing fuctions.
...
/*!
@brief
    Destroys the recording session clearing handle \lt_p{handle}.
...
/*!
@brief
    Waits for the recording session clearing operation identified by
...
@param[in] handle
    ...
    operation for which to wait for completion.
@param[in] timeout_ms
...
/*!
@brief
    Sets \lt_p{*result} to the result of the recording session clearing
